...
import { fetchLlmGenGenderRiskData, fetchStateGenderRiskData } from "@/services/api"; // Assuming same API fetch function
...
const GenderRiskData: React.FC = () => {
    ...
    const handleAnalysisClick = async () => {
        ...
        try {
            const result = await fetchLlmGenGenderRiskData({
